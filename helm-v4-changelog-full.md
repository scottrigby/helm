...
## Analysis Overview
Analyzed 219 Pull Requests from main branch (v4.0.0-alpha.1) compared to dev-v3 (v3.19.0-rc.1)

**Total PRs:** 219
**Backported to v3 (excluded):** 23
**Helm v4 only:** 196
...
**Total v4-only changes: 196 PRs** (excluding 23 backported to v3)
