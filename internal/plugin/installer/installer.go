...
func FindSource(location string) (Installer, error) {
	// For finding existing sources, use the same logic as NewForSource
	// VCS detection is removed - users should install a git getter plugin if needed
	return NewForSource(location, "")
}
